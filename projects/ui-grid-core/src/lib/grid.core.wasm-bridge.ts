...
export const shouldGridEditOnFocus: typeof tsEdit.shouldGridEditOnFocus = (options, column) =>
  withWasm(
    (wasm) =>
      wasm.should_grid_edit_on_focus_js({ options: normalizeOptionsForWasm(options), column }),
...
export const findGridRowById: typeof tsIdentity.findGridRowById = tsIdentity.findGridRowById;
...
export const resolveGridRowId: typeof tsIdentity.resolveGridRowId = tsIdentity.resolveGridRowId;
